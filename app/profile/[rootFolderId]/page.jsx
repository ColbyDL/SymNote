    ...
    <div className="">
      <div className="flex flex-row">
        <div className="flex flex-row justify-start items-center backdrop-blur-lg bg-white/10 w-1/2 ml-10 h-20 rounded-l-3xl">
          <div className="px-4 pl-20">
            <button>
              <FontAwesomeIcon icon={faFileCirclePlus} onClick={() => {
              setModalType("file");
              setIsModalOpen(true);
            }} className="text-4xl" />
            </button>
          ...
          <div className="px-4">
            <button>
              <FontAwesomeIcon icon={faFolderPlus} onClick={() => {
              setModalType("folder");
              setIsModalOpen(true);
            }} className="text-4xl" />
            </button>
        ...
        <div className="flex flex-row justify-around items-center backdrop-blur-lg bg-white/10 w-1/2 mr-10 h-40 rounded-b-3xl rounded-r-3xl">
          ...
          <div className="flex justify-end">
            <FontAwesomeIcon icon={faTrashCan} className="text-4xl" />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row">
        <div className="flex flex-col backdrop-blur-lg bg-white/10 w-1/2 h-96 mx-20 rounded-2xl overflow-auto p-4">
          {rootFolder && rootFolder.files ? rootFolder.files.map(f => (
            <div key={f._id} className="flex flex-row justify-stretch items-center border-b-2 p-3">
              <Link href={`/documents/${f._id}`} className="flex flex-row justify-start items-center w-4/5">
              ...
              <div className="flex flex-row justify-end items-center w-1/5">
                <button>
                  <FontAwesomeIcon icon={faArrowRight} className="text-xl px-4" />
                </button>
                <button>
                  <FontAwesomeIcon icon={faTrashCan} className="text-xl px-4" />
                </button>
              </div>
            </div>
        ...
        <div className="w-1/2 h-96 mx-20 grid grid-cols-4 overflow-auto p-4 gap-4 pt-20">
          {rootFolder && rootFolder.folders ? rootFolder.folders.map(f => (
            <div key={f._id}>
              <Link href={`/profile/${f._id}`} className="flex flex-col justify-center items-center">
