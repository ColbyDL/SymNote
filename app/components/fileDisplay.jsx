...
const fileDisplay = () => {
  ...
  return (
        <tr className="">
            ...
            <td className="border border-slate-400 text-center bg-slate-200"><Link href="/" className="transition duration-100 transform hover:font-bold text-sky-600 text-2xl hover:text-4xl hover:text-red-700">Edit</Link></td>
